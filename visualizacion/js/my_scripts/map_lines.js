	            ...
	            $.ajax({
                      ...
                      cache: false,
	          	      ...
	          	      success: function(data) {
	          			...
	          			$("#estado_peticion").html("<font style='color:green;font-weight:500px'>[OK.ESTACIONES]</font>");
	          	})
	          	.fail(function() {
    ...
    $.ajax({
          ...
          cache: false,
  	      ...
  	      success: function(data) {
  			...
  			$("#estado_peticion").html("<font style='color:green;font-weight:500px'>[OK.CONEXIONES]</font>");
  	})
  	.fail(function() {
  		$("#estado_peticion").append("<font style='color:red;font-weight:500px'>[ERROR.CONEXIONES]</font>");
  	})
  	.always(function() {
  	   // alert( "complete" );
  	});
